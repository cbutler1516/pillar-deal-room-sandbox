...
export const DEMO_DEALS: DemoDeal[] = [
  ...
  },
  {
    ...
    contacts: [],
    tasks: [
      task(521, "prepare_submission", "Prepare submission package", "All required items approved. Ready for mock submission.", "low", "completed", daysAgo(1), {
        playbookKey: "prepare_submission",
        sourceType: "internal",
        taskKind: "prepare_submission",
        timing: "required_later",
        instructions:
          "Walk the Client Needs list. Required items on this file are approved or waived. Mark complete when the mock package is assembled. This does not submit to a lender.",
        completionRule:
          "Complete when the processor confirms required-now items are satisfied or waived. This is not an underwriting or credit decision.",
      }),
    ],
